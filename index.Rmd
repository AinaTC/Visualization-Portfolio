...
__Reflection on final result__

The map is quite clear, showing areas with higher cost thicker that tracks with lower costs, and making the Ligth rail stand over a transparent background, which adds information but does not take over. with areas more expensive being thickest. Nevertheless adding labels for Most Suitable and Less suitable next to the suitabiliy lengend would make it better.3 scenarios were plotted due to uncertanies about the real cost, which price is significantly different, but better information about cost would solve the problem. The criteria used to select suitability areas is subjective, and prefered areas could differ applying different criteria. This allows to change suitability according to the user's preferences.

----

# __Near-Real-Time temperature interpolation__

<img src="images/Capture.jpg" width="650px">
...
Quickly understand the temperature from the map.
...
## Metadata
- __Course name :__ Modelling and geo statistics
- __Course code:__
- __Application of the products:__ Flood management
- __Potential users:__ Policy makers
- __Potential users' requirements:__ Easy to interprete
- __Visualisation type:__ 
- __Dataset(s):__ Height point data, influx distribution data
- __Processing method(s):__ Kriging, MonteCarlo
- __Tools used:__ NetLogo, Rstudio
- __Reflection on result:__ Result shows clearly areas safe and hazarduous, with distinct colous, but no information on the ucertanty. Such information is important for the quality of the model, but, if uncertanty is not ver big, the plot distinguishing safe and hazarduous areas can be used quite safely by policy makers without taking risks.
