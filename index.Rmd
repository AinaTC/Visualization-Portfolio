...
Result shows clearly areas safe and hazardous, with distinct colous, but no information on the uncertainty. Such information is important for the quality of the model, but, if uncertainty is not very big, the plot distinguishing safe and hazardous areas can be used quite safely by policy makers without taking risks.
